...
class LSL:
    ...
    def borrarDato(self, dato):
        ...
        if nodo is None:
            ...
            self.desconectar(nodo, anterior)

    def desconectar(self, nodo, anterior):
        """
    ...
    def __getitem__(self, index):
        """
        Sobrecarga para poder acceder a los datos de la lista por su posición: mi_lsl[0], mi_lsl[2]...
        """
        if self.esVacia():
